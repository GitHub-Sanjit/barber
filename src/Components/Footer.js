        ...
        <div id="footer" className="myfooter">
            ...
            <div className="card">
                ...
                <div className="card-body">
                    ...
                    <p className="text">Address: Jsahore</p>
                    <p className="text">Phone: +880 1575 017430</p>
                    <p className="text">Email: sanjit.est14@gmail.com</p>
                </div>
            </div>

            <div><br /><br />
                <p id="rights">All rights reserved | This template is made by Sanjit Sarkar</p><br />
            </div>
